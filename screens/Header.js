    ...
    <View style={styles.profile_container}>
      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        <TouchableOpacity onPress={() => navigation.navigate('DrawerTab')}>
          <Image source={require('./assets/profile.jpeg')} style={styles.imgstyl} />
        </TouchableOpacity>
        <View>
          <Text style={{ fontWeight: 'bold', fontSize: 16 }}>Welcome Koushik</Text>
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
  ...
  return (
    <View style={styles.iconsContainer}>
      <TouchableOpacity onPress={() => navigation.navigate('Notification')}>
        <Image source={require("./assets copy/notification_icon.png")}style={{height:25,width:25}}/>
